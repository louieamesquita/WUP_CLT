...
the standard deviation now is a quarter of what is now 10
...
The standard deviation shrinks as the number gets higher example 4 is divided by 2, 9 is divided by 3. 16 divided by 4 and so on. the expected value is not the original data we collected. the deviation is going to stay the same. The higher the example 4 is divided by 2, 9 is divided by 3. 16 divided by 4 and so on. The standard deviation is with n=9 'r not'. 

we expected 14 and we got `r sd (my1000$k3)`
...
The standard deviation is now a quarter but before was a 10.
...
```
expected deviation to be 8 but got "r sd(my1000$k5)"
...
We exspected deviation to be 6 but got 6.7655755149369, or 7 
